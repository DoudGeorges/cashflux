...
from friday_tools import FridayContext, dispatch_tool, tool_declarations
...
def run_friday_chat(
    ...
    *,
    ...
    for _ in range(MAX_TOOL_ROUNDS):
        ...
        reply = reply or "I completed the requested actions. Let me know if you need anything else."
